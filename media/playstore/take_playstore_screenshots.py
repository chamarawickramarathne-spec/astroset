"""
Generate Google Play Store screenshots for AstroSet.
Creates 4 phone screenshots at 1080x1920 (9:16 portrait).
Each shows a full-page view of a key app screen.
"""
import os, time
...
# Google Play Store recommended phone size
WIDTH = 1080
HEIGHT = 1920

# Shared CSS for full-bleed Play Store screenshots
PS_CSS = """
...
# ── TODAY SCREEN (1080x1920) ──────────────────────────────
TODAY_HTML = f"""<!DOCTYPE html>
<html><head><meta charset="utf-8"><style>{PS_CSS}</style></head>
<body>
<div class="screen">
  ...
  <div class="content">
    ...
    <div class="card">
      ...
      <div class="card-value" style="font-size:52px;">&#x1F319; Waning Gibbous</div>
    ...
    <div class="card">
      ...
      <div style="font-size:28px; line-height:40px; color:#e0e0ff;">
        Today brings a powerful alignment in your communication sector. The cosmos encourages you to express your creative vision with confidence. Financial opportunities may arise through unexpected channels.
      </div>
  ...
  <div class="content">
    ...
    <div class="card">
      ...
      <div class="chart-area">
        <svg width="100%" height="100%" viewBox="0 0 960 320" preserveAspectRatio="none">
          <!-- Threshold lines -->
          <line x1="0" y1="64" x2="960" y2="64" stroke="#f1c40f" stroke-width="1" stroke-dasharray="8"/>
          <text x="940" y="60" fill="#f1c40f" font-size="16" text-anchor="end">C</text>
          <line x1="0" y1="32" x2="960" y2="32" stroke="#e67e22" stroke-width="1" stroke-dasharray="8"/>
          <text x="940" y="28" fill="#e67e22" font-size="16" text-anchor="end">M</text>
          <line x1="0" y1="8" x2="960" y2="8" stroke="#e74c3c" stroke-width="1" stroke-dasharray="8"/>
          <text x="940" y="8" fill="#e74c3c" font-size="16" text-anchor="end">X</text>
          <!-- Day gridlines -->
          <line x1="137" y1="0" x2="137" y2="320" stroke="#3a3a6a" stroke-width="1"/>
          <line x1="274" y1="0" x2="274" y2="320" stroke="#3a3a6a" stroke-width="1"/>
          <line x1="411" y1="0" x2="411" y2="320" stroke="#3a3a6a" stroke-width="1"/>
          <line x1="548" y1="0" x2="548" y2="320" stroke="#3a3a6a" stroke-width="1"/>
          <line x1="685" y1="0" x2="685" y2="320" stroke="#3a3a6a" stroke-width="1"/>
          <line x1="822" y1="0" x2="822" y2="320" stroke="#3a3a6a" stroke-width="1"/>
          <!-- Flux line -->
          <defs><linearGradient id="areaFill" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stop-color="#f59e0b" stop-opacity="0.3"/>
            <stop offset="100%" stop-color="#f59e0b" stop-opacity="0"/>
          </linearGradient></defs>
          <path d="M0,252 L40,256 L80,248 L120,250 L160,242 L200,246 L240,234 L280,226 L300,184 L310,160 L320,176 L340,218 L360,230 L400,238 L440,234 L480,226 L500,200 L510,192 L520,208 L560,230 L600,234 L640,226 L680,238 L720,234 L760,226 L800,200 L820,192 L840,208 L880,230 L920,234 L960,226 L960,320 L0,320Z" fill="url(#areaFill)"/>
          <path d="M0,252 L40,256 L80,248 L120,250 L160,242 L200,246 L240,234 L280,226 L300,184 L310,160 L320,176 L340,218 L360,230 L400,238 L440,234 L480,226 L500,200 L510,192 L520,208 L560,230 L600,234 L640,226 L680,238 L720,234 L760,226 L800,200 L820,192 L840,208 L880,230 L920,234 L960,226" fill="none" stroke="#f59e0b" stroke-width="3"/>
          <!-- Date labels -->
          <text x="137" y="310" fill="#a0a0cc" font-size="16" text-anchor="middle">Aug 21</text>
          <text x="274" y="310" fill="#a0a0cc" font-size="16" text-anchor="middle">Aug 22</text>
          <text x="411" y="310" fill="#a0a0cc" font-size="16" text-anchor="middle">Aug 23</text>
          <text x="548" y="310" fill="#a0a0cc" font-size="16" text-anchor="middle">Aug 24</text>
          <text x="685" y="310" fill="#a0a0cc" font-size="16" text-anchor="middle">Aug 25</text>
          <text x="822" y="310" fill="#a0a0cc" font-size="16" text-anchor="middle">Aug 26</text>
          <text x="960" y="310" fill="#a0a0cc" font-size="16" text-anchor="middle">Aug 27</text>
        </svg>
      </div>
    ...
    <div class="card">
      ...
      <div class="spectrogram-area">
        <svg width="90%" height="80%" viewBox="0 0 860 250">
          <rect width="860" height="250" fill="#0a0a18"/>
          <rect x="0" y="180" width="860" height="70" fill="#1a0a30" opacity="0.5"/>
          <rect x="0" y="140" width="860" height="40" fill="#2a1050" opacity="0.4"/>
          <rect x="0" y="100" width="860" height="40" fill="#401a60" opacity="0.3"/>
          <rect x="0" y="60" width="860" height="40" fill="#502a40" opacity="0.2"/>
          <rect x="0" y="20" width="860" height="40" fill="#603a20" opacity="0.15"/>
          <line x1="0" y1="196" x2="860" y2="196" stroke="#4a9eff" stroke-width="1" opacity="0.4"/>
          <text x="8" y="192" fill="#4a9eff" font-size="14">7.83 Hz</text>
          <line x1="0" y1="148" x2="860" y2="148" stroke="#4a9eff" stroke-width="0.5" opacity="0.3"/>
          <text x="8" y="144" fill="#4a9eff" font-size="14">14.3 Hz</text>
          <text x="20" y="240" fill="#a0a0cc" font-size="14">UTC+7 03:00</text>
          <text x="760" y="240" fill="#a0a0cc" font-size="14">Now</text>
        </svg>
      </div>
      <div class="schumann-summary">Schumann resonance activity is at moderate levels. The fundamental frequency shows normal oscillation patterns with slight intensification.</div>
  ...
  <div class="content">
    ...
    <div class="card">
      ...
      <div style="display:flex;gap:40px;margin-top:28px;padding-top:28px;border-top:1px solid #3a3a6a;">
        <span style="font-size:28px;color:#a0a0cc;">&#x1F305; Sunrise: 6:12 AM</span>
        <span style="font-size:28px;color:#a0a0cc;">&#x1F307; Sunset: 6:28 PM</span>
      </div>
    </div>
...
def main():
    with sync_playwright() as p:
        ...
        for screen_name, html in SCREENS.items():
            ...
            time.sleep(0.3)
            path = os.path.join(OUT, f"playstore_{screen_name}.png")
            page.screenshot(path=path, full_page=False)
            size_kb = os.path.getsize(path) / 1024
            print(f"  {path}  ({size_kb:.0f} KB)")
            page.close()
        browser.close()
    print(f"\nDone -- {len(SCREENS)} Play Store screenshots at {WIDTH}x{HEIGHT}")
